...
def parse_args():
    ...
    parser.add_argument("--inf-eplen", type=int, default=100,
                        help="total number of timesteps of the experiments")
...
def inference(seed,args):
    ...
    #log_dir = "ppo_5bunkers_2presses_4_seed_13_budget_2000000_ent-coef_0.0_gamma_0.99_steps_6144/"
    ...
    while True:
        ...
        #print(volumes)
        y_volumes = volumes
        x_volumes = np.arange(episode_length)
        env.render(y_volumes)
